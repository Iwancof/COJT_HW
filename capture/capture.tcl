...
\
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins capture_0/RESOL] [get_bd_pins display_0/RESOL] [get_bd_pins dispsub_0/RESOL]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins capture_0/ACLK] [get_bd_pins display_0/ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps2if_v1_0_0/s00_axi_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins regbus_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk] [get_bd_pins sccb_0/s00_axi_aclk]
  ...
  connect_bd_net -net regbus_0_BYTEEN [get_bd_pins capture_0/BYTEEN] [get_bd_pins display_0/BYTEEN] [get_bd_pins regbus_0/BYTEEN]
  connect_bd_net -net regbus_0_RDADDR [get_bd_pins capture_0/RDADDR] [get_bd_pins display_0/RDADDR] [get_bd_pins regbus_0/RDADDR]
  connect_bd_net -net regbus_0_RDEN [get_bd_pins capture_0/RDEN] [get_bd_pins display_0/RDEN] [get_bd_pins regbus_0/RDEN]
  connect_bd_net -net regbus_0_WDATA [get_bd_pins capture_0/WDATA] [get_bd_pins display_0/WDATA] [get_bd_pins regbus_0/WDATA]
  connect_bd_net -net regbus_0_WRADDR [get_bd_pins capture_0/WRADDR] [get_bd_pins display_0/WRADDR] [get_bd_pins regbus_0/WRADDR]
  connect_bd_net -net regbus_0_WREN [get_bd_pins capture_0/WREN] [get_bd_pins display_0/WREN] [get_bd_pins regbus_0/WREN]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins capture_0/ARESETN] [get_bd_pins display_0/ARESETN] [get_bd_pins dispsub_0/ARESETN] [get_bd_pins ps2if_v1_0_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins regbus_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn] [get_bd_pins sccb_0/s00_axi_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins regbus_0/RDATA_DRAW] [get_bd_pins regbus_0/RDATA_OPT0] [get_bd_pins regbus_0/RDATA_OPT1] [get_bd_pins regbus_0/RDATA_OPT2] [get_bd_pins regbus_0/RDATA_OPT3] [get_bd_pins regbus_0/RDATA_SOUND] [get_bd_pins xlconstant_0/dout]
