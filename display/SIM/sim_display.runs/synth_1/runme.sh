...
HD_PWD='C:/Users/HW101.COJTHW/COJT/display/SIM/sim_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log disp_vramctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source disp_vramctrl.tcl
