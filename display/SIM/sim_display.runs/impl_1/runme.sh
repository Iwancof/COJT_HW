...
HD_PWD='C:/Users/HW101.COJTHW/COJT/display/SIM/sim_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log disp_vramctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source disp_vramctrl.tcl -notrace
